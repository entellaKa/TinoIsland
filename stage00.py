import pygame, mapList, inventory, player, stage01, home
import os, getpass
...
def runGame():
    ...
    while not done:
        ...
        if map1[player.pos_y//20-1][player.pos_x//30] == 1:
            # map1 = mapList.map2
            # player.pos_y = 530
            pygame.quit()
            ...
            # subprocess.call("./stage01.py", shell=True)
        elif map1[player.pos_y//20-1][player.pos_x//30] == 5:
            home.runGame()
